...
enum {
	...
	AC_TASK_DBG_ID,
	AC_TASK_DISPLAY_ID,
	AC_TASK_GAME_PLAYER_ID,
	AC_TASK_GAME_ENEMY_ID,
	AC_TASK_GAME_BULLET_ID,
	AC_TASK_GAME_STAGE_ID,
...
extern void game_player_task(ak_msg_t*);
extern void game_enemy_task(ak_msg_t*);
extern void game_bullet_task(ak_msg_t*);
extern void game_stage_task(ak_msg_t*);
